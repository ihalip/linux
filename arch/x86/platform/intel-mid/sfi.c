...
static int ipc_next_dev __ro_after_init;
static int spi_next_dev __ro_after_init;
static int i2c_next_dev __ro_after_init;
static int i2c_bus[MAX_SCU_I2C];
static int gpio_num_entry __ro_after_init;
static u32 sfi_mtimer_usage[SFI_MTMR_MAX_NUM];
int sfi_mrtc_num __ro_after_init;
int sfi_mtimer_num __ro_after_init;
